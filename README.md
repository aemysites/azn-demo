...
## Environments
- Preview: https://main--azn-demo--aemysites.aem.page/
- Live: https://main--azn-demo--aemysites.aem.live/
- Block Library: https://main--azn-demo--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `azn-demo` directory in your favorite IDE and start coding :)
